...
class OrganizationWebhooks(_OrgPartitionedStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property("name", th.StringType, description="The name of the webhook."),
        th.Property(
            "display_name",
            th.StringType,
        ...
        th.Property(
            "active", th.BooleanType, description="Whether the webhook is active."
        ),
    ).to_dict()
...
class OrganizationWebhookDeliveries(PulumiCloudStream):
    ...
    primary_keys: t.Sequence[str] = ["org_name", "webhook_name", "id"]
    records_jsonpath = "$[*]"
    ...
    schema = th.PropertiesList(
        ...
        th.Property(
            "webhook_name", th.StringType, description="The name of the webhook."
        ),
        th.Property("id", th.StringType, description="The ID of the delivery."),
        th.Property("kind", th.StringType, description="The kind of the delivery."),
        th.Property(
            "payload", th.StringType, description="The payload of the delivery."
        ),
        th.Property(
            "timestamp", th.IntegerType, description="The timestamp of the delivery."
        ),
        th.Property(
            "duration", th.IntegerType, description="The duration of the delivery."
        ),
        th.Property(
            "request_url", th.StringType, description="The URL of the request."
        ),
        th.Property(
            "request_headers", th.StringType, description="The headers of the request."
        ),
        th.Property(
            "response_code",
            th.IntegerType,
        ...
        th.Property(
            "response_body", th.StringType, description="The body of the response."
        ),
    ).to_dict()
...
class StackWebhookDeliveries(PulumiCloudStream):
    ...
    path = (
        "/api/stacks/{org_name}/{project_name}/{stack_name}"
        "/hooks/{webhook_name}/deliveries"
    )

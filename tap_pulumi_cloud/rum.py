...
class RumUsageDaily(_OrgPartitionedStream):
    ...
    primary_keys = ["org_name", "year", "month", "day"]
    ...
    th.Property(
        "year",
        th.IntegerType,
        description="The year of the RUM usage."
    ),
    th.Property(
        "month",
        th.IntegerType,
        description="The month of the RUM usage."
    ),
    th.Property(
        "day",
        th.IntegerType,
        description="The day of the RUM usage."
    ),
    th.Property(
        "resources",
        th.IntegerType,
        description="Daily RUM usage."
    ),
    th.Property(
        "resourceHours",
        th.IntegerType,
        description="Hourly RUM usage."
    )
).to_dict()
